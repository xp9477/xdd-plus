...
var Admin = `<html lang="zh-cn">
    ...
    <head>
        ...
        <title>账号管理</title>
        <link rel="stylesheet" href="https://fastly.jsdelivr.net/gh/cdle/static/layui/css/layui.css">
        <script src="https://fastly.jsdelivr.net/gh/cdle/static/layui/layui.all.js"></script>
    </head>
